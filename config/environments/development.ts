...
export let env = {
  ...
  uploads: {
    ...
    postImageURL: `/public/images/posts/`, // Post upload destination path,
    yogaNidrasAdudioURL: `/public/audio/`, // Yoga Nindra upload destination path
    yogaVinyasasVideoURL: `/public/video/` // Yoga Vinyasas upload destination path
  },
  database: {
    host: `localhost`,
    port: `27017`,
